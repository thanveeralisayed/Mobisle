...
class MyPasswordChangeForm(PasswordChangeForm):
    ...
    new_password1 = forms.CharField(label=_("New Password"),strip=False,widget=forms.PasswordInput(attrs={'autocomplete':'new-password','class':'form-control'}),help_text=password_validation._password_validators_help_text_html())
...
class CustomerProfileForm(forms.ModelForm):
    class Meta:
        model = Customer
        fields = ['name','landmark','place','zipcode','state']
